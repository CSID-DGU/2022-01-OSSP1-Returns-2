    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        service.GetCourse().enqueue(new Callback<CourseResponse>() {
            ...
            public void onResponse(Call<CourseResponse> call, Response<CourseResponse> response) {
                ...
                Toast.makeText(activity_home.this, ""+courseData[0].getLatitude(), Toast.LENGTH_SHORT).show();
            }
...
//        LatLng latLng5 = new LatLng(lat[0], lon[0]);
//        MarkerOptions markerOptions5 = new MarkerOptions().position(latLng5).title("Hi");
//        markerOptions5.snippet("Hello");
